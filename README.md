...
Copy it from [EscPosEncoder](https://github.com/NielsLeenheer/EscPosEncoder)
...
First, install the package using npm:
    ...
    npm install web-esc-pos-encoder --save

Then, require the package and use it like so:

    let EscPosEncoder = require('web-esc-pos-encoder');
